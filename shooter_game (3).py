...
img_back = "galaxy.jpg"
img_player = "roketa.png"
img_enemy = "ufos.png"
img_bullet = "lych.jpg"
img_asteroid = "asteroiid.png"
...
for i in range(1, 3):
    asteroid = Enemy2(img_asteroid, randint(0, width-85), 0, 80, 40, randint(1, 2))
    ...
    if not finish:
        ...
        if rel_time:
            ...
            if now_time - last_time < 3:
                reloads = text1.render("reloding", 1,(255,0,0))
                window.blit(reloads, ((width//2-30), height-50)) 
            else:
                num_fire = 0
                rel_time = False
        ...
        for i in range(1, 6):
            ...
            monsters.add(monster)
        for i in range(1, 3):
            asteroid = Enemy2(img_asteroid, randint(0, width-85),
                            0, 80, 40, randint(1, 3))
            asteroids.add(asteroid)
    clock.tick(FPS)
